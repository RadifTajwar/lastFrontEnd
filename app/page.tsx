...
export default function Home() {
  ...
  return (
    <>
      {/* Section 1 start  */}
      <div className="section_1_parent " style={{ background: 'linear-gradient(90deg, #F5FCF4 0%, #E5F8E5 100%)', height:'94vh' }}>
        <div className="section1 mx-auto w-9/12 flex pt-20">
          ...
          <div className="section1_left w-1/2" style={{ marginTop: '100px', position: 'relative' }}>
            ...
            <div className="storyBtn flex justify-center">
              <Link href="/home">
                <button className="border rounded lg py-3 px-3 my-5 hover:bg-green-500 hover:text-white" style={{ border: '1px solid black' }}>
